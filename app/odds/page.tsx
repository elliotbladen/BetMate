...
function OddsBoardCard({
  ...
  return (
    <article className={['relative overflow-hidden rounded-xl border bg-white transition-all duration-200', expanded ? 'border-[#00DEB8] shadow-[0_0_0_3px_rgba(0,222,184,0.10)]' : 'border-[#E2E8F0]'].join(' ')}>
