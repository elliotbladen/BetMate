...
export const MODEL_BETS: ModelBet[] = [
  ...
  { id:25, date:'2026-04-24', match:'Wests Tigers vs Canberra',                market:'Under 52.5',        predictedLine:51.5, takenPrice:1.9,  closingPrice:null, result:'win',  plUnits:1.5,   runningTotal:0.75  },
  { id:26, date:'2026-04-24', match:'St George vs Penrith',                    market:'St George Win',     predictedLine:2.2,  takenPrice:1.9,  closingPrice:null, result:'loss', plUnits:-1,    runningTotal:-0.25 },
  // R11 Magic Round
  { id:27, date:'2026-05-15', match:'Cronulla vs Canterbury',                  market:'Under 49',          predictedLine:49.0, takenPrice:1.90, closingPrice:2.12, result:'loss', plUnits:-1,    runningTotal:-1.25 },
  { id:28, date:'2026-05-15', match:'Rabbitohs vs Dolphins',                   market:'Dolphins Win',      predictedLine:null, takenPrice:1.85, closingPrice:1.74, result:'win',  plUnits:0.85,  runningTotal:-0.40 },
  { id:29, date:'2026-05-16', match:'Roosters vs Cowboys',                     market:'Cowboys +16.5',     predictedLine:7.6,  takenPrice:1.74, closingPrice:1.85, result:'win',  plUnits:0.74,  runningTotal:0.34  },
  { id:30, date:'2026-05-17', match:'Warriors vs Broncos',                     market:'Warriors -2.5',     predictedLine:13.0, takenPrice:1.91, closingPrice:1.90, result:'win',  plUnits:0.91,  runningTotal:1.25  },
  { id:31, date:'2026-05-17', match:'Panthers vs Dragons',                     market:'Under 56.5',        predictedLine:46.5, takenPrice:1.82, closingPrice:2.12, result:'win',  plUnits:0.82,  runningTotal:2.07  },
  // R12
  { id:32, date:'2026-05-22', match:'Canterbury Bulldogs vs Melbourne Storm',  market:'Bulldogs -3.5',     predictedLine:1.4,  takenPrice:1.90, closingPrice:1.90, result:'win',  plUnits:0.90,  runningTotal:2.97  },
  { id:33, date:'2026-05-24', match:'Cowboys vs South Sydney Rabbitohs',       market:'Cowboys Win',       predictedLine:1.56, takenPrice:1.67, closingPrice:1.58, result:'win',  plUnits:0.67,  runningTotal:3.64  },
  { id:34, date:'2026-05-24', match:'Cowboys vs South Sydney Rabbitohs',       market:'Cowboys -2.5',      predictedLine:4.3,  takenPrice:1.90, closingPrice:1.80, result:'win',  plUnits:0.90,  runningTotal:4.54  },
  // R13 — ids 36-41 all 0.5u stakes ($25)
  { id:35, date:'2026-05-29', match:'Cronulla Sharks vs Manly Sea Eagles',     market:'Cronulla Win',      predictedLine:1.72, takenPrice:1.87, closingPrice:1.80, result:'win',  plUnits:0.87,  runningTotal:5.41  },
  { id:36, date:'2026-05-31', match:'Penrith Panthers vs NZ Warriors',         market:'Under 46.5',        predictedLine:44.1, takenPrice:1.84, closingPrice:2.08, result:'win',  plUnits:0.42,  runningTotal:5.83  },
  { id:37, date:'2026-05-31', match:'Penrith Panthers vs NZ Warriors',         market:'Under 47.5',        predictedLine:44.1, takenPrice:1.90, closingPrice:2.08, result:'win',  plUnits:0.45,  runningTotal:6.28  },
  { id:38, date:'2026-05-31', match:'Penrith Panthers vs NZ Warriors',         market:'Panthers -3.5',     predictedLine:12.7, takenPrice:1.83, closingPrice:1.95, result:'loss', plUnits:-0.50, runningTotal:5.78  },
  { id:39, date:'2026-05-31', match:'Penrith Panthers vs NZ Warriors',         market:'Panthers -5.5',     predictedLine:12.7, takenPrice:1.72, closingPrice:1.95, result:'loss', plUnits:-0.50, runningTotal:5.28  },
  { id:40, date:'2026-05-30', match:'Wests Tigers vs Canterbury Bulldogs',     market:'Over 48.5',         predictedLine:48.5, takenPrice:1.90, closingPrice:1.95, result:'loss', plUnits:-0.50, runningTotal:4.78  },
  { id:41, date:'2026-05-31', match:'Canberra Raiders vs Cowboys',             market:'Cowboys +4.5',      predictedLine:1.3,  takenPrice:1.73, closingPrice:1.95, result:'loss', plUnits:-0.50, runningTotal:4.28  },
  // R14 — all 0.5u stakes ($25/$20)
  { id:42, date:'2026-06-05', match:'Melbourne Storm vs Newcastle Knights',     market:'Newcastle +4.5',    predictedLine:0.6,  takenPrice:1.85, closingPrice:1.90, result:'win',  plUnits:0.43,  runningTotal:4.71  },
  { id:43, date:'2026-06-06', match:'North Queensland Cowboys vs Dolphins',     market:'Cowboys Win',       predictedLine:2.64, takenPrice:2.38, closingPrice:2.65, result:'loss', plUnits:-0.50, runningTotal:4.21  },
  { id:44, date:'2026-06-06', match:'Brisbane Broncos vs Gold Coast Titans',    market:'Under 50.5',        predictedLine:39.7, takenPrice:1.90, closingPrice:2.08, result:'loss', plUnits:-0.50, runningTotal:3.71  },
  { id:45, date:'2026-06-07', match:'Wests Tigers vs Penrith Panthers',         market:'Under 49.5',        predictedLine:46.4, takenPrice:1.91, closingPrice:2.20, result:'loss', plUnits:-0.50, runningTotal:3.21  },
  { id:46, date:'2026-06-07', match:'Cronulla Sharks vs St George Illawarra',   market:'Cronulla -10.5',    predictedLine:16.7, takenPrice:1.91, closingPrice:1.90, result:'win',  plUnits:0.46,  runningTotal:3.67  },
  { id:47, date:'2026-06-08', match:'Canterbury Bulldogs vs Parramatta Eels',   market:'Bulldogs -5.5',     predictedLine:9.6,  takenPrice:1.88, closingPrice:1.85, result:'loss', plUnits:-0.50, runningTotal:3.17  },
  { id:48, date:'2026-06-08', match:'Canterbury Bulldogs vs Parramatta Eels',   market:'Bulldogs -6.5',     predictedLine:9.6,  takenPrice:1.97, closingPrice:1.85, result:'loss', plUnits:-0.50, runningTotal:2.67  },
];
