...
export const MODEL_BETS: ModelBet[] = [
  ...
  { id:40, date:'2026-05-30', match:'Wests Tigers vs Canterbury Bulldogs',     market:'Over 48.5',         predictedLine:null, takenPrice:1.90, closingPrice:null, result:'loss', plUnits:-0.50, runningTotal:4.78  },
  { id:41, date:'2026-05-31', match:'Canberra Raiders vs Cowboys',             market:'Cowboys +4.5',      predictedLine:null, takenPrice:1.73, closingPrice:null, result:'loss', plUnits:-0.50, runningTotal:4.28  },
  // R14 — all 0.5u stakes ($25/$20)
  { id:42, date:'2026-06-05', match:'Melbourne Storm vs Newcastle Knights',     market:'Newcastle +4.5',    predictedLine:null, takenPrice:1.85, closingPrice:null, result:'win',  plUnits:0.43,  runningTotal:4.71  },
  { id:43, date:'2026-06-06', match:'North Queensland Cowboys vs Dolphins',     market:'Cowboys Win',       predictedLine:null, takenPrice:2.38, closingPrice:null, result:'loss', plUnits:-0.50, runningTotal:4.21  },
  { id:44, date:'2026-06-06', match:'Brisbane Broncos vs Gold Coast Titans',    market:'Under 50.5',        predictedLine:null, takenPrice:1.90, closingPrice:null, result:'loss', plUnits:-0.50, runningTotal:3.71  },
  { id:45, date:'2026-06-07', match:'Wests Tigers vs Penrith Panthers',         market:'Under 49.5',        predictedLine:null, takenPrice:1.91, closingPrice:null, result:'loss', plUnits:-0.50, runningTotal:3.21  },
  { id:46, date:'2026-06-07', match:'Cronulla Sharks vs St George Illawarra',   market:'Cronulla -10.5',    predictedLine:null, takenPrice:1.91, closingPrice:null, result:'win',  plUnits:0.46,  runningTotal:3.67  },
  { id:47, date:'2026-06-08', match:'Canterbury Bulldogs vs Parramatta Eels',   market:'Bulldogs -5.5',     predictedLine:null, takenPrice:1.88, closingPrice:null, result:'loss', plUnits:-0.50, runningTotal:3.17  },
  { id:48, date:'2026-06-08', match:'Canterbury Bulldogs vs Parramatta Eels',   market:'Bulldogs -6.5',     predictedLine:null, takenPrice:1.97, closingPrice:null, result:'loss', plUnits:-0.50, runningTotal:2.67  },
];
