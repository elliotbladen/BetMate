...
export const AFL_MODEL_BETS: ModelBet[] = [
  ...
  { id:11, date:'2026-04-25', match:'Brisbane vs Adelaide Crows',              market:'Under 189.5',          predictedLine:null, takenPrice:2.00, closingPrice:1.90, result:'loss', plUnits:-1.00,  runningTotal:2.50   },
  // R8 (Apr 30 - May 2)
  ...
  { id:13, date:'2026-05-01', match:'Western Bulldogs vs Fremantle',           market:'Bulldogs Win',         predictedLine:null, takenPrice:3.21, closingPrice:3.15, result:'loss', plUnits:-0.66,  runningTotal:0.84   },
  { id:14, date:'2026-05-01', match:'Adelaide vs Port Adelaide',               market:'Adelaide -9.5',        predictedLine:null, takenPrice:1.89, closingPrice:1.95, result:'loss', plUnits:-1.00,  runningTotal:-0.16  },
  { id:15, date:'2026-05-02', match:'Carlton vs St Kilda',                     market:'Carlton Win',          predictedLine:null, takenPrice:2.55, closingPrice:2.45, result:'loss', plUnits:-0.80,  runningTotal:-0.96  },
  { id:16, date:'2026-05-02', match:'Carlton vs St Kilda',                     market:'Under 183.5',          predictedLine:null, takenPrice:1.89, closingPrice:1.85, result:'win',  plUnits:0.89,   runningTotal:-0.07  },
  // R9 (May 8-9)
  { id:17, date:'2026-05-08', match:'Port Adelaide vs Western Bulldogs',       market:'Port Adelaide Win',    predictedLine:null, takenPrice:1.96, closingPrice:2.00, result:'loss', plUnits:-1.00,  runningTotal:-1.07  },
  { id:18, date:'2026-05-09', match:'Gold Coast vs St Kilda',                  market:'Gold Coast -17.5',     predictedLine:null, takenPrice:1.89, closingPrice:1.85, result:'win',  plUnits:0.89,   runningTotal:-0.18  },
  { id:19, date:'2026-05-09', match:'Geelong vs Collingwood',                  market:'Geelong -11.5',        predictedLine:null, takenPrice:1.89, closingPrice:1.90, result:'win',  plUnits:0.89,   runningTotal:0.71   },
  { id:20, date:'2026-05-09', match:'GWS vs Essendon',                         market:'Under 193.5',          predictedLine:null, takenPrice:1.87, closingPrice:1.85, result:'win',  plUnits:0.87,   runningTotal:1.58   },
  // R10 (May 15-16)
  ...
  // R11 (May 21-23)
  { id:27, date:'2026-05-21', match:'Hawthorn vs Adelaide Crows',             market:'Hawthorn Win',          predictedLine:null, takenPrice:1.41, closingPrice:1.55, result:'win',  plUnits:0.45,   runningTotal:3.03   },
  { id:28, date:'2026-05-21', match:'Hawthorn vs Adelaide Crows',             market:'Adelaide Crows Win',    predictedLine:null, takenPrice:2.88, closingPrice:2.45, result:'loss', plUnits:-0.50,  runningTotal:2.53   },
  ...
  { id:32, date:'2026-05-23', match:'Geelong Cats vs Sydney Swans',           market:'Swans +10.5',           predictedLine:null, takenPrice:1.90, closingPrice:1.85, result:'loss', plUnits:-0.50,  runningTotal:2.42   },
  { id:33, date:'2026-05-23', match:'Collingwood vs West Coast Eagles',       market:'Under 180.5',           predictedLine:null, takenPrice:1.87, closingPrice:1.99, result:'win',  plUnits:0.44,   runningTotal:2.86   },
  // R12 (May 28 - Jun 1)
  { id:34, date:'2026-05-28', match:'St Kilda vs Hawthorn',                   market:'Hawthorn -19.5',        predictedLine:null, takenPrice:1.90, closingPrice:1.90, result:'win',  plUnits:0.45,   runningTotal:3.31   },
  { id:35, date:'2026-05-29', match:'Carlton vs Geelong Cats',                market:'Over 178.5',            predictedLine:null, takenPrice:1.89, closingPrice:1.80, result:'loss', plUnits:-0.50,  runningTotal:2.81   },
  { id:36, date:'2026-05-30', match:'Western Bulldogs vs Collingwood',        market:'Collingwood Win',        predictedLine:null, takenPrice:2.26, closingPrice:2.35, result:'loss', plUnits:-0.50,  runningTotal:2.31   },
  { id:37, date:'2026-05-31', match:'West Coast Eagles vs Essendon',          market:'Essendon Win (cash out)', predictedLine:null, takenPrice:2.31, closingPrice:2.80, result:'win',  plUnits:0.40,   runningTotal:2.71   },
  { id:38, date:'2026-05-31', match:'West Coast Eagles vs Essendon',          market:'Essendon Win',           predictedLine:null, takenPrice:2.39, closingPrice:2.80, result:'loss', plUnits:-0.50,  runningTotal:2.21   },
  // R13 (Jun 5-8)
  { id:39, date:'2026-06-05', match:'Hawthorn vs Western Bulldogs',           market:'Hawthorn -11.5',         predictedLine:null, takenPrice:1.90, closingPrice:1.95, result:'loss', plUnits:-0.50,  runningTotal:1.71   },
  ...
  { id:42, date:'2026-06-06', match:'Gold Coast Suns vs Brisbane Lions',      market:'Under 188.5',            predictedLine:null, takenPrice:1.88, closingPrice:2.04, result:'win',  plUnits:0.44,   runningTotal:1.25   },
  { id:43, date:'2026-06-06', match:'West Coast Eagles vs Port Adelaide',     market:'Port Adelaide -6.5',     predictedLine:null, takenPrice:1.88, closingPrice:1.90, result:'loss', plUnits:-0.60,  runningTotal:0.65   },
  { id:44, date:'2026-06-06', match:'West Coast Eagles vs Port Adelaide',     market:'Port Adelaide -7.5',     predictedLine:null, takenPrice:1.90, closingPrice:1.90, result:'loss', plUnits:-0.50,  runningTotal:0.15   },
  { id:45, date:'2026-06-07', match:'Sydney Swans vs St Kilda',               market:'Sydney -29.5',           predictedLine:null, takenPrice:1.89, closingPrice:1.95, result:'loss', plUnits:-0.50,  runningTotal:-0.35  },
  { id:46, date:'2026-06-07', match:'Essendon vs Carlton',                    market:'Under 168.5',            predictedLine:null, takenPrice:1.89, closingPrice:2.00, result:'win',  plUnits:0.45,   runningTotal:0.10   },
