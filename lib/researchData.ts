...
export const AFL_MODEL_BETS: ModelBet[] = [
  ...
  { id:37, date:'2026-05-31', match:'West Coast Eagles vs Essendon',          market:'Essendon Win (cash out)', predictedLine:null, takenPrice:2.31, closingPrice:null, result:'win',  plUnits:0.40,   runningTotal:2.71   },
  { id:38, date:'2026-05-31', match:'West Coast Eagles vs Essendon',          market:'Essendon Win',           predictedLine:null, takenPrice:2.39, closingPrice:null, result:'loss', plUnits:-0.50,  runningTotal:2.21   },
  // R13 (Jun 5-8)
  { id:39, date:'2026-06-05', match:'Hawthorn vs Western Bulldogs',           market:'Hawthorn -11.5',         predictedLine:null, takenPrice:1.90, closingPrice:null, result:'loss', plUnits:-0.50,  runningTotal:1.71   },
  { id:40, date:'2026-06-05', match:'Hawthorn vs Western Bulldogs',           market:'Hawthorn -20.5',         predictedLine:null, takenPrice:1.91, closingPrice:null, result:'loss', plUnits:-0.40,  runningTotal:1.31   },
  { id:41, date:'2026-06-05', match:'Hawthorn vs Western Bulldogs',           market:'Hawthorn -20.5',         predictedLine:null, takenPrice:1.91, closingPrice:null, result:'loss', plUnits:-0.50,  runningTotal:0.81   },
  { id:42, date:'2026-06-06', match:'Gold Coast Suns vs Brisbane Lions',      market:'Under 188.5',            predictedLine:null, takenPrice:1.88, closingPrice:null, result:'win',  plUnits:0.44,   runningTotal:1.25   },
  { id:43, date:'2026-06-06', match:'West Coast Eagles vs Port Adelaide',     market:'Port Adelaide -6.5',     predictedLine:null, takenPrice:1.88, closingPrice:null, result:'loss', plUnits:-0.60,  runningTotal:0.65   },
  { id:44, date:'2026-06-06', match:'West Coast Eagles vs Port Adelaide',     market:'Port Adelaide -7.5',     predictedLine:null, takenPrice:1.90, closingPrice:null, result:'loss', plUnits:-0.50,  runningTotal:0.15   },
  { id:45, date:'2026-06-07', match:'Sydney Swans vs St Kilda',               market:'Sydney -29.5',           predictedLine:null, takenPrice:1.89, closingPrice:null, result:'loss', plUnits:-0.50,  runningTotal:-0.35  },
  { id:46, date:'2026-06-07', match:'Essendon vs Carlton',                    market:'Under 168.5',            predictedLine:null, takenPrice:1.89, closingPrice:null, result:'win',  plUnits:0.45,   runningTotal:0.10   },
  ...
  { id:48, date:'2026-06-08', match:'Collingwood vs Melbourne',               market:'Collingwood Win',         predictedLine:null, takenPrice:1.90, closingPrice:null, result:'loss', plUnits:-0.40,  runningTotal:0.14   },
  { id:49, date:'2026-06-08', match:'Collingwood vs Melbourne',               market:'Collingwood Win',         predictedLine:null, takenPrice:1.90, closingPrice:null, result:'loss', plUnits:-0.50,  runningTotal:-0.36  },
  // R14 (Jun 11-14)
