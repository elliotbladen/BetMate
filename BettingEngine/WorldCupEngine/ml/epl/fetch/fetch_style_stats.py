...
Output:
  ml/epl/data/style/ppda_by_season.csv   — season-level team averages
  ml/epl/data/style/ppda_rolling.csv     — rolling 10-game PPDA per team

Usage:
    python ml/epl/fetch/fetch_style_stats.py
"""
...
OUT_DIR = Path(__file__).parent.parent / "data" / "style"
