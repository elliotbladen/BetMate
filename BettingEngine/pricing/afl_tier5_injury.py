...
IMPACT_TABLE = {
    ...
    ('key_forward',  'good'):    (-3.0, -2.0),   # 2-3 avg goals; was -3.5 — reduced per 2026 outcome data
    ...
    ('small_forward','elite'):   (-1.5, -0.5),   # pressure forward + goals
    ('small_forward','good'):    (-1.0, -0.5),
    ('small_forward','average'): (-0.5,  0.0),
    ('small_forward','depth'):   ( 0.0,  0.0),

    ('midfielder',   'elite'):   (-3.0, -1.5),   # elite inside mid (Oliver, Cripps); was -3.5 — research shows declining midfielder importance in modern AFL
    ('midfielder',   'good'):    (-1.5, -0.5),   # was -2.0 — reduced; contested ball win rate declining as predictor
