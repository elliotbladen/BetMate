...
## CURRENT STATE
**Researched UCL reprice 2026-09-08:** User requested internet research and use of current injuries/domestic form/rest. Downloaded domestic results and UEFA/club availability; built context for all 24 teams. Corrected research fit now converges, with explicit club-ID reconciliation and opt-in rate-preserving DC normalization. Nine provisional 1X2 scenario prices saved in `outputs/football/ucl/2026-09-08_researched/run1/report.md`; AEK–LASK, Lille–Betis, Stuttgart–Viking still lack comparable opponent strength. These are not full-tier production prices; separate totals remain withheld. Fifteen targeted tests passed. See `handover/sessions/2026-09-08_ucl-researched-repricing.md`.

**UCL execution audit 2026-09-08:** Attempted 12 fixtures for European Sep 8–9 / Sydney Sep 9–10 using existing Python. Generic `price_match.py --league ucl` fails with `KeyError: 'rho'`; UCL adapter produced nine diagnostic outputs but fit did not converge. Three fixtures lack opponent history (LASK, Real Betis, Viking). Zero proper full-tier prices. Live team news/referee sources exist but are not consumed by the adapter. See `handover/sessions/2026-09-08_ucl-md1-pricing-attempt.md`.

**Context review 2026-09-08:** Core instructions, architecture decisions and recent handovers reviewed. Older overview sections below are historical and can conflict with newer sport-specific records. See `handover/sessions/2026-09-08_system-context-review.md` for the current reading map; no pricing or operational changes were made during this review.

**Last updated:** 2026-09-08 (Finals emotional tier + football CLV. **AFL T6 emotional priced for the first time** on the semis; **NRL T7 corrected** — Cowboys shame_blowout (lost by 20 vs a 30+ threshold) and Souths star_return (Latrell returned in R27) were both invalid. Sharks -12.0->-13.0, Souths -10.7->-9.2, AFL totals +1.0. Finals pricing saved in `data/pricing/{nrl,afl}` ready to score. **Historical odds refreshed** — AFL to 09-05, NRL to 09-06, EPL 4590 / Championship 6684 to 09-06; football-data's `www` vhost was 503 while the bare domain served fine, and the fetcher was silently merging stale Internet Archive rows (fixed). **Football season ledger:** EPL 13 bets ROI -33.92% CLV +7.78%; EFL 8 bets 0 wins ROI -100% CLV +6.67%. Full-round model-vs-market: EPL at parity with the close on 1X2 and better on O/U; EFL lost every metric. **DECISION PENDING: EFL Championship engine reviewed 2026-09-22** — keep betting both leagues until then; EFL CLV is one-bet-deep (drops to -0.77% without Millwall) and it lost the full-round model-vs-market on every metric, while EPL survives the same tests. Open: Odds API still DEACTIVATED_KEY; `data/nrl/origin/2026.json` missing here; RacingEngine DB a week stale. See `handover/sessions/2026-09-08_finals-pricing-football-clv-and-data-refresh.md`.)

**Prior:** 2026-08-12 (Independent NRL XGBoost shadow v1 built and wired after official pricing. Walk-forward: 2024 margin MAE 14.36/H2H 61.0%, 2025 MAE 14.31/H2H 59.2%. R24 shadow generated and stored. Rules prices remain official; rule tiers are diagnostic only and are no longer added to ML. Historical closing-market coverage for 2024–25 is only 65/426 games in the current workbook, so ROI is preliminary. See `handover/sessions/2026-08-12_nrl-ml-shadow-v1-build.md`.)
