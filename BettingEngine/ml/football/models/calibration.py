...
def fit_and_save(
    ...
    """
    from ml.football.backtest.walk_forward import rps as rps_fn
...
if __name__ == "__main__":
    results_csv = Path(__file__).parent.parent / "data" / "epl" / "clv" / "backtest_results.csv"
    out_path    = Path(__file__).parent.parent / "data" / "epl" / "clv" / "calibration_report.json"
