...
class TrialSourceRegistryTests(unittest.TestCase):
    ...
    def test_url_rendering_is_encoded(self):
        source = next(row for row in trial_sources.load_registry()['sources'] if row['source_id']=='racing_nsw')
